...
{
    public class NTraderExecutionBridge : Strategy
    {
        ...
        private readonly string inPath = @"C:\NTraderSystem\bridge\in";
        private readonly string outPath = @"C:\NTraderSystem\bridge\out";
        private readonly string processedPath = @"C:\NTraderSystem\bridge\processed";
        private readonly string errorPath = @"C:\NTraderSystem\bridge\error";
        ...
        protected override void OnStateChange()
        {
            ...
            {
                Name = "NTraderExecutionBridge";
                Description = "Bridge JSON endurecido con validación de instrumento y correlación mejorada";
        ...
        // Formato: C:\NTraderSystem\bridge\out\bars_MES_5m.json
        // =====================================================================
        ...
        private void ExportBarSeries(string instrument, string tf, NinjaTrader.Data.Bars bars, int count)
        {
            ...
            // Escribir en temp y renombrar atómicamente
        ...
        private string NormalizeInstrumentForBot(string instrument)
        {
            ...
            string upper = instrument.Trim().ToUpperInvariant();

            if (upper.StartsWith("MES")) return "MES";
            if (upper.StartsWith("MNQ")) return "MNQ";
            if (upper.StartsWith("MGC")) return "MGC";
            if (upper.StartsWith("MCL")) return "MCL";
            if (upper.StartsWith("ES")) return "ES";
            if (upper.StartsWith("RTY")) return "RTY";
            if (upper.StartsWith("M2K")) return "M2K";
